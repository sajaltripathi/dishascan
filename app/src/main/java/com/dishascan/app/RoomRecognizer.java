...
public class RoomRecognizer implements ImageAnalysis.Analyzer {
    ...
    public void analyze(final ImageProxy p) {
        ...
        this.lab.process(im).addOnSuccessListener(new OnSuccessListener() { // from class: com.dishascan.app.RoomRecognizer$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                interpret((List) obj);
            }
        }).addOnCompleteListener(new OnCompleteListener() { // from class: com.dishascan.app.RoomRecognizer$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                lambda$analyze$0(p, task);
            }
        });
    }
