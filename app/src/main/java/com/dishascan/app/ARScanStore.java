...
public class ARScanStore {
    ...
    public File latest(final String propertyId) {
        File d = new File(this.context.getFilesDir(), "ar_scans");
        File[] fs = d.listFiles(new FilenameFilter() { // from class: com.dishascan.app.ARScanStore$$ExternalSyntheticLambda0
        ...
        Arrays.sort(fs, new Comparator() { // from class: com.dishascan.app.ARScanStore$$ExternalSyntheticLambda1
