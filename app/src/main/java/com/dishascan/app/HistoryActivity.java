    ...
    private void refresh() {
        ...
        for (final File f : this.store.list(this.pid)) {
            try {
                ...
                Button v = b("VIDEO");
                v.setOnClickListener(new View.OnClickListener() { // from class: com.dishascan.app.HistoryActivity$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        lambda$refresh$0(s, view);
                    }
                });
                actions.addView(v);
                Button csv = b("CSV");
                csv.setOnClickListener(new View.OnClickListener() { // from class: com.dishascan.app.HistoryActivity$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        lambda$refresh$1(s, view);
                    }
                });
                actions.addView(csv);
                Button fl = b("PLAN");
                fl.setOnClickListener(new View.OnClickListener() { // from class: com.dishascan.app.HistoryActivity$$ExternalSyntheticLambda2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        lambda$refresh$2(f, view);
                    }
                });
                actions.addView(fl);
                Button pdf = b("PDF");
                pdf.setOnClickListener(new View.OnClickListener() { // from class: com.dishascan.app.HistoryActivity$$ExternalSyntheticLambda3
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        lambda$refresh$3(f, view);
                    }
                });
                actions.addView(pdf);
                c.addView(actions);
