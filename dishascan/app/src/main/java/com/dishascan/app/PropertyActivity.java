...
public class PropertyActivity extends ComponentActivity {
    ...
    protected void onCreate(Bundle b) {
        ...
        add.setOnClickListener(new View.OnClickListener() { // from class: com.dishascan.app.PropertyActivity$$ExternalSyntheticLambda0
    ...
    private void refresh() {
        ...
        for (final PropertyStore.Property p : this.store.all()) {
            ...
            o.setOnClickListener(new View.OnClickListener() { // from class: com.dishascan.app.PropertyActivity$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    lambda$refresh$1(p, view);
                }
            });
            c.addView(o);
            this.list.addView(c);
    ...
    private void add() {
        ...
        f.addView(a);
        f.addView(no);
        new AlertDialog.Builder(this).setTitle("New property").setView(f).setPositiveButton("Create", new DialogInterface.OnClickListener() { // from class: com.dishascan.app.PropertyActivity$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                lambda$add$2(n, a, no, dialogInterface, i);
            }
