...
public class SurveySessionStore {
    ...
    public List<File> list(String pid) {
        ...
        File d = new File(this.c.getFilesDir(), "sessions");
        File[] fs = d.listFiles(new FilenameFilter() { // from class: com.dishascan.app.SurveySessionStore$$ExternalSyntheticLambda0
        ...
        out.sort(new Comparator() { // from class: com.dishascan.app.SurveySessionStore$$ExternalSyntheticLambda1
